...
function warning() {
  var dialog = confirm(
    "Para utilizar o gerador selecione a imagem base (resolução 1080x1920), a data do cardápio e insira o texto copiado diretamente do site da PRA. Aperte OK para obter um exemplo do texto a ser copiado.\n\nVersão do site: " +
      version +
      "\nCriado por Vicente Parmigiani\nContato: vicenteparmigiani@ufpr.br"
  );
  if (dialog == true) {
    alert(
...
function getTheText() {
  try {
    ...
    alert(
      'Você deve inserir um texto válido retirado do cardápio da PRA, aperte "Ajuda" para mais informações.'
    );
  }
}
